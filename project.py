...
def nextb():
    ...
    asd = Label(
        bn,
        text="You have successfuly loged in to your gmail account",
        font="callibri 15",
        bg="white",
    )
    asq = Label(
        bn, text="Click next to use your gmail account", font="callibri 15", bg="white"
    )
...
def create_an_account():
    ...
    m = Button(
        ki, text="Cancel", font="callibri 15", bg="white", fg="blue", command=cancels
    )
    m.place(x=470, y=330)
